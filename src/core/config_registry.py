...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "US_INTRADAY_WINDOWS": {
        ...
        "description": "Comma-separated checkpoint windows: pre_open, open_15, open_60, midday, power_hour, close_15.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "pre_open,open_15,open_60,midday,power_hour,close_15",
        "options": [],
        "validation": {},
        "display_order": 49,
    },
