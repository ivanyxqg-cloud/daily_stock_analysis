...
gh variable set US_INTRADAY_CATCHUP_MINUTES --repo "$repo" --body "45"
gh variable set US_INTRADAY_CLOSE_CATCHUP_MINUTES --repo "$repo" --body "120"
...
gh variable set US_INTRADAY_REQUIRE_FRESH_QUOTES --repo "$repo" --body "true"
gh variable set US_INTRADAY_QUOTE_FRESHNESS_MINUTES --repo "$repo" --body "20"
gh variable set US_INTRADAY_PRE_OPEN_FAST_MODE --repo "$repo" --body "true"
gh variable set US_COMMANDER_ENABLED --repo "$repo" --body "true"
gh variable set US_COMMANDER_MODE --repo "$repo" --body "swing_intraday"
gh variable set US_COMMANDER_RISK_STYLE --repo "$repo" --body "balanced"
gh variable set US_COMMANDER_LLM_MODE --repo "$repo" --body "triggered"
gh variable set US_COMMANDER_MAX_ACTIONS --repo "$repo" --body "5"
gh variable set US_COMMANDER_MAX_OPPORTUNITIES --repo "$repo" --body "3"
gh variable set US_COMMANDER_MIN_ALERT_SCORE --repo "$repo" --body "70"
gh variable set US_COMMANDER_MEMORY_ENABLED --repo "$repo" --body "true"
gh variable set US_COMMANDER_LANGUAGE_STYLE --repo "$repo" --body "plain_with_terms"
gh variable set US_COMMANDER_SHOW_TERM_EXPLANATIONS --repo "$repo" --body "true"
gh variable set US_COMMANDER_MAX_LEARNING_NOTES --repo "$repo" --body "3"
gh variable set US_COMMANDER_OPTIONS_ENABLED --repo "$repo" --body "true"
gh variable set US_COMMANDER_OPTION_MIN_DTE --repo "$repo" --body "14"
gh variable set US_COMMANDER_OPTION_MAX_DTE --repo "$repo" --body "45"
gh variable set US_COMMANDER_OPTION_MAX_RISK_PCT --repo "$repo" --body "1.0"
gh variable set US_COMMANDER_DIRECTNESS --repo "$repo" --body "aggressive"
gh variable set US_COMMANDER_POSITION_SIZING --repo "$repo" --body "relative"
gh variable set US_COMMANDER_CARD_STYLE --repo "$repo" --body "command_first"
gh variable set US_COMMANDER_BRIEF_MODE --repo "$repo" --body "true"
gh variable set US_COMMANDER_BRIEF_MAX_LINES --repo "$repo" --body "8"
gh variable set US_COMMANDER_VISUAL_CARD --repo "$repo" --body "true"
gh variable set US_COMMANDER_TERM_GLOSSARY_MODE --repo "$repo" --body "footer"
gh variable set US_COMMANDER_MAX_GLOSSARY_TERMS --repo "$repo" --body "2"
gh variable set MARKDOWN_TO_IMAGE_CHANNELS --repo "$repo" --body "telegram"
gh variable set MD2IMG_ENGINE --repo "$repo" --body "markdown-to-file"
