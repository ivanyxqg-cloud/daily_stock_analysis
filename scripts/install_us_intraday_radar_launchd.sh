...
SCRIPT_DIR="${0:A:h}"
SOURCE_WATCHDOG_SCRIPT="$SCRIPT_DIR/us_intraday_radar_watchdog.sh"
APP_SUPPORT_DIR="$HOME/Library/Application Support/us-intraday-radar"
WATCHDOG_SCRIPT="$APP_SUPPORT_DIR/us_intraday_radar_watchdog.sh"
...
cp "$SOURCE_WATCHDOG_SCRIPT" "$WATCHDOG_SCRIPT"
