...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "US_INTRADAY_RADAR_ENABLED": {
        "title": "US Intraday Radar",
        "description": "Enable concise US intraday radar alerts at configured market checkpoints.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "US_INTRADAY_WINDOWS": {
        "title": "US Intraday Windows",
        "description": "Comma-separated checkpoint windows: pre_open, open_15, open_30, open_60, midday, power_hour, close_15.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "pre_open,open_15,open_30,open_60,midday,power_hour,close_15",
        "options": [],
        "validation": {},
        "display_order": 49,
    },
    "US_INTRADAY_ALERT_HOLDING_CHANGE_PCT": {
        "title": "US Holding Alert %",
        "description": "Intraday percentage move threshold for holding alerts.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_INTRADAY_ALERT_INDEX_CHANGE_PCT": {
        "title": "US Index Alert %",
        "description": "Intraday percentage move threshold for broad-index or theme-proxy alerts.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_INTRADAY_ALERT_VIX_CHANGE_PCT": {
        "title": "US VIX Alert %",
        "description": "Intraday VIX percentage move threshold for fear/risk alerts.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_INTRADAY_PUSH_NIGHT": {
        "title": "US Intraday Night Push",
        "description": "Allow Beijing-time overnight pushes for US close/power-hour windows.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "US_INTRADAY_OPPORTUNITY_MAX": {
        "title": "US Intraday Opportunity Max",
        "description": "Maximum number of non-holding candidates shown in each intraday radar alert.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_INTRADAY_REPORT_LANGUAGE": {
        "title": "US Intraday Report Language",
        "description": "Language for US intraday radar reports. Use zh for Chinese Telegram alerts.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "US_INTRADAY_WINDOW_TOLERANCE_MINUTES": {
        "title": "US Intraday Window Tolerance",
        "description": "Legacy exact-window tolerance. Catch-up settings below handle late GitHub schedule delivery.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_INTRADAY_CATCHUP_MINUTES": {
        "title": "US Intraday Catch-up Minutes",
        "description": "Minutes after regular checkpoints during which a late scheduled run may still send the alert.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_INTRADAY_CLOSE_CATCHUP_MINUTES": {
        "title": "US Intraday Close Catch-up",
        "description": "Minutes after the close-summary checkpoint during which a late scheduled run may still send the alert.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_INTRADAY_POLL_INTERVAL_MINUTES": {
        "title": "US Intraday Poll Interval",
        "description": "Mac/local scheduler polling interval in minutes when --intraday-radar --schedule is used.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_INTRADAY_READABLE_REPORT": {
        "title": "US Intraday Readable Report",
        "description": "Use a mobile-friendly action-card format for Telegram intraday alerts.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "US_INTRADAY_JARGON_LEVEL": {
        "title": "US Intraday Jargon Level",
        "description": "Controls terminology in Telegram alerts: explained keeps terms with plain-language explanations; plain hides most jargon; technical uses the full technical report.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "explained",
        "options": ["explained", "plain", "technical"],
        "validation": {"enum": ["explained", "plain", "technical"]},
        "display_order": 50,
    },
    "US_INTRADAY_MAX_ACTION_ITEMS": {
        "title": "US Intraday Action Items",
        "description": "Maximum number of urgent action items shown near the top of each Telegram intraday alert.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_INTRADAY_SHOW_TECHNICAL_DETAILS": {
        "title": "US Intraday Technical Details",
        "description": "Include technical details in Telegram alerts. Keep false for compact mobile messages; full details are still saved as artifacts.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "US_INTRADAY_DEDUPE_ENABLED": {
        "title": "US Intraday Dedupe",
        "description": "Prevent duplicate Telegram pushes for the same US intraday window by checking GitHub artifact markers.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "US_INTRADAY_DEDUPE_LOOKBACK_HOURS": {
        "title": "US Intraday Dedupe Lookback",
        "description": "Hours to look back for duplicate-send marker artifacts.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
