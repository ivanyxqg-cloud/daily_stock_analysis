...
export US_COMMANDER_VISUAL_CARD="${US_COMMANDER_VISUAL_CARD:-true}"
...
export MARKDOWN_TO_IMAGE_CHANNELS="${MARKDOWN_TO_IMAGE_CHANNELS:-telegram}"
export MD2IMG_ENGINE="${MD2IMG_ENGINE:-markdown-to-file}"
