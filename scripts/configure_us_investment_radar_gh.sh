...
gh variable set US_COMMANDER_VISUAL_CARD --repo "$repo" --body "false"
...
gh variable set MARKDOWN_TO_IMAGE_CHANNELS --repo "$repo" --body ""
gh variable set MD2IMG_ENGINE --repo "$repo" --body "wkhtmltoimage"
