...
gh variable set US_INTRADAY_WINDOWS --repo "$repo" --body "pre_open,open_15,open_60,midday,power_hour,close_15"
...
gh variable set US_INTRADAY_WINDOW_TOLERANCE_MINUTES --repo "$repo" --body "12"
